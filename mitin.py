...
st.write('Currently, student projects and achievements are often scattered across different platforms, making it difficult for recruiters to identify the right students. MITin solves this by bringing everything together in one college-specific platform.
